...
class Settings extends CI_Controller {
    ...
    public function view_super_admin()
	{
		...
		$img_data = file_get_contents($tanda_tangan[0]->value);
		$data['tanda_tangan'] = base64_encode($img_data);
    ...
    public function tanda_tangan()
	{
		...
		if ($tanda_tangan) {
			...
			$path = "uploads/tanda_tangan/signature-primary.png";
			file_put_contents("./$path", $decoded_image);
			$ttd = $path;

			$this->m_settings->tanda_tangan($ttd);
		}
