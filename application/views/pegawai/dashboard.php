                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="<?= base_url(); ?>Izin/view_pegawai/<?= $this->session->userdata('id_user'); ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    ...
                                    <p>Data Izin Menunggu Konfirmasi</p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-person-add"></i>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"> Cuti tahunan adalah cuti yang diberikan pada pekerja dengan waktu setidaknya 12 hari
                                         setelah karyawan tersebut sudah bekerja selama minimal 1 tahun bekerja.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Cuti Besar : 3 Bulan</h5>
                                    <p class="card-text">Bila Pegawai jatuh sakit dan tidak memungkinkan untuk melakukan
                                        pekerjaan,
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Untuk persalinan anak yang pertama, kedua, dan ketiga, Pegawai
                                        wanita
                                        ...
                                        dan
                                        selama menjalankan cuti ini, Pegawai wanita masih berhak mendapatkan penghasilannya.
                                    </p>
                                </div>
                            </div>
                        </div>
