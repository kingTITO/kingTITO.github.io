                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($file_path) : ?>
                                                            <a href="<?= base_url().$file_path ?>" target="_blank" download>Download</a>
                                                        <?php else : ?>
                                                            -
                                                        <?php endif; ?>
                                                    </td>
                                                    ...
                                                    <td><?php if ($id_status_cuti == 2) { ?>
                                                            <a href="<?= base_url(); ?>Cetak/surat_cuti_pdf/<?= $id_cuti ?>" class="btn btn-info" target="_blank">
                                                                Cetak Surat
                                                            </a>
                                                        <?php } else { ?>
                                                    ...
                                                    <td>
                                                        <div class="table-responsive">
                                                            <div class="table table-striped table-hover ">
                                                                <a href="" class="btn btn-primary" data-toggle="modal" data-target="#edit<?= $id_cuti ?>">
                                                        ...
                                                        <div class="table-responsive">
                                                            <div class="table table-striped table-hover ">
                                                                <a href="" data-toggle="modal" data-target="#hapus<?= $id_cuti ?>" class="btn btn-danger"><i class="fas fa-trash"></i>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <!-- Modal Edit Cuti -->
                                                <div class="modal fade" id="edit<?= $id_cuti ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal fade" id="hapus<?= $id_cuti ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="<?php echo base_url() ?>Cuti/hapus_cuti_admin" method="post" enctype="multipart/form-data">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
