        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Dashboard | by <a href='https://id.linkedin.com/in/nur-anggoro-3b6474128' title='https://id.linkedin.com/in/nur-anggoro-3b6474128' target='_blank'>PUTRA ENGINEERING</a>
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="<?= base_url(); ?>Izin/view_admin" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
