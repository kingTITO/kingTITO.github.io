...
class M_cuti extends CI_Model
{
    ...
    public function insert_data_cuti($id_cuti, $id_user, $alasan, $mulai, $berakhir, $id_status_cuti, $perihal_cuti, $file_path, $ttd)
    {
        $this->db->trans_start();
		$query = "INSERT INTO cuti(id_cuti,id_user, alasan, tgl_diajukan, mulai, berakhir, id_status_cuti, perihal_cuti, file_path, tanda_tangan) VALUES ('$id_cuti','$id_user','$alasan',NOW(),'$mulai', '$berakhir', '$id_status_cuti', '$perihal_cuti', '$file_path', '$ttd')";
		// var_dump($query);
		// die();
        $this->db->query($query);
